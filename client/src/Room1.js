  ...
  return(
    <>
        ...
        <Suspense fallback={null}>
          ...
          <Camera position={[2.2, 1.05, 0.7]} scale={[0.5, 0.5, 0.5]} />
          <Rose position={[1.85, 0.95, 1.27]} scale={[0.003, 0.003, 0.003]}/>
          ...
          <Notebook position={[2.25, 0.98, 1.85]} scale={[0.02, 0.02, 0.02]}/>
          ...
          <T position={[1.85, 0.3, 1.38]} scale={[0.007, 0.007, 0.007]} rotation={[0, -Math.PI/2, 0]}/>
        </Suspense>
